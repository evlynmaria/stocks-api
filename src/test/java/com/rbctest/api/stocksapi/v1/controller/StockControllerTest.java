...
public class StockControllerTest {
	...
	public void testAddStockWithFutureDate() {
		...
		Stock stock = new Stock(1, "TEST", "01/07/2023", "$15.82", "$16.72", "$15.78", "$16.42", "239655616", 3.79267,
				"1.222", "3.333", "$16.71", "$15.97", -4.42849, 26, 0.182704);
		ResponseEntity<Object> responseEntity = stockController.createStock(stock);
	...
	public void testAddDuplicateStock() {
		...
		Stock stock = new Stock(1, "TEST", "01/07/2023", "$15.82", "$16.72", "$15.78", "$16.42", "239655616", 3.79267,
				"1.222", "3.333", "$16.71", "$15.97", -4.42849, 26, 0.182704);
		Stock stock2 = new Stock(1, "TEST", "01/07/2023", "$15.82", "$16.72", "$15.78", "$16.42", "239655616", 3.79267,
				"1.222", "3.333", "$16.71", "$15.97", -4.42849, 26, 0.182704);
		ResponseEntity<Object> responseEntity = stockController.createStock(stock);
	...
	public void testFetchMatchingStock() {
		...
		Stock stock = new Stock(1, "TEST", "01/07/2011", "$15.82", "$16.72", "$15.78", "$16.42", "239655616", 3.79267,
				"1.222", "3.333", "$16.71", "$15.97", -4.42849, 26, 0.182704);
		Stock stock2 = new Stock(1, "TEST", "01/07/2010", "$15.82", "$16.72", "$15.78", "$16.42", "239655616", 3.79267,
				"1.222", "3.333", "$16.71", "$15.97", -4.42849, 26, 0.182704);
